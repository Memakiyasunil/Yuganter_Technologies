...
export default function FullStackCourse() {
  ...
  const faqItems = [
    {
      question: "How long is MERN stack course?",
      answer: "The MERN stack course usually takes 6 months including live projects.",
    },
    {
      question: "What projects are included in MERN stack training?",
      answer:
        "Students build real-world projects like admin panels, authentication systems, APIs, and full stack web apps.",
    },
    {
      question: "Do you provide internship?",
      answer: "Yes, students get internship opportunities with real projects.",
    },
  ];
...
/>
      ...
      <FAQSection items={faqItems} schemaId="mern-course-faq-schema" />
