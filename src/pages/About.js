...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-[#071d34] text-white flex flex-col">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              {stats.map((s, i) => (
                ...
                >
                  ...
                  <p className="text-slate-300 mt-1">{s.label}</p>
                </motion.div>
              ))}
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <motion.div
  className="bg-gradient-to-r from-blue-600 to-blue-700 p-8 rounded-3xl text-white shadow-lg hover:shadow-2xl transition"
  variants={fadeInUp}
>
  <div className="text-6xl mb-4">🚀</div>
    ...
    with practical skills and ethical values.
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
           ...
           <motion.section
            className="bg-[#071d34] text-white py-16"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeInUp}
          >
            <div className="max-w-6xl mx-auto px-6 space-y-6">
              ...
              {/* Your Existing Motion Paragraph */}
              <motion.p
