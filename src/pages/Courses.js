...
export default function Courses() {
  ...
  return (
    <div className="bg-[#071d34] text-white min-h-screen">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                className="px-6 py-3 border-2 border-blue-500 text-indigo-500 rounded-xl font-semibold hover:bg-indigo-700 hover:text-white transition"
              >
                Call: +91 6355582605
              </a>
