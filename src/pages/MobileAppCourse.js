      ...
      <main className="flex-grow py-24 bg-[#071d34]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl p-12 mb-16 border border-gray-700">
            <div className="flex flex-col lg:flex-row items-center gap-8 mb-12">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg text-slate-300 leading-relaxed max-w-2xl">{course.description}</p>
              </div>
            </div>
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl p-12 mb-16 border border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {course.careerOpportunities.map((opportunity, idx) => (
                <div
                  key={idx}
                  className="p-6 bg-gray-700 rounded-xl hover:bg-gray-600 transition-all duration-300 transform border border-gray-600"
                >
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl p-12 mb-16 border border-gray-700">
            ...
            <p className="text-slate-300 text-lg">{course.prerequisites}</p>
          </div>
