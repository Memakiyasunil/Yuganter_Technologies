...
export default function BacklinkGuide() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#071d34]">
            <Navbar />
            <PageHeader
            ...
            <main className="flex-grow py-16">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="bg-gradient-to-r from-secondary-50 to-primary-50 rounded-2xl p-8 mb-12">
                        <h3 className="text-2xl font-bold text-white mb-6">Target Local Keywords</h3>
                        <div className="grid md:grid-cols-2 gap-4">
                            {localKeywords.map((keyword, index) => (
                                <div key={index} className="bg-[#071d34] rounded-lg p-4 shadow-sm border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        {backlinkStrategies.map((strategy, index) => (
                            <div key={index} className="bg-[#071d34] rounded-xl shadow-lg p-6 border border-gray-100">
                                    ...
                                    <ul className="space-y-1">
                                        {strategy.platforms.map((platform, idx) => (
                                            <li key={idx} className="text-gray-600 flex items-center">
                                                <span className="w-2 h-2 bg-secondary-400 rounded-lg mr-3"></span>
                                                {platform}
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className="bg-[#071d34] rounded-xl shadow-lg p-8 mb-12">
                        <h3 className="text-2xl font-bold text-white mb-6">Content Creation for Backlinks</h3>
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="text-center">
                                <div className="w-16 h-16 bg-secondary-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                                    <span className="text-2xl">📝</span>
                                </div>
                                <h4 className="font-bold text-white mb-2">Technical Articles</h4>
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="font-bold text-white mb-2">Industry Reports</h4>
                                <p className="text-gray-600 text-sm">
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="font-bold text-white mb-2">Video Content</h4>
                                <p className="text-gray-600 text-sm">
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8 mb-12">
                        <h3 className="text-2xl font-bold text-white mb-6">30-Day Action Plan</h3>
                        <div className="space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-white">Week 1: Foundation</h4>
                                    <p className="text-gray-600">Set up Google My Business, claim listings, optimize social profiles</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 bg-blue-500 text-white rounded-lg flex items-center justify-center font-bold text-sm">2</div>
                                <div>
                                    <h4 className="font-bold text-white">Week 2: Content Creation</h4>
                                    <p className="text-gray-600">Publish 3-5 blog posts and share on relevant communities</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 bg-purple-500 text-white rounded-lg flex items-center justify-center font-bold text-sm">3</div>
                                <div>
                                    <h4 className="font-bold text-white">Week 3: Outreach</h4>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-white">Week 4: Monitoring & Scaling</h4>
                    ...
                    {/* Call to Action */}
                    <div className="text-center">
                        <h3 className="text-2xl font-bold text-white mb-4">Ready to Build Backlinks?</h3>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link
                                to="/contact"
                                className="px-8 py-3 border-2 border-secondary-500 text-secondary-500 hover:bg-blue-600 hover:text-white font-semibold rounded-lg transition-colors"
                            >
