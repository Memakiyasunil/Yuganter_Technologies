  ...
  return (
    <div className="min-h-screen bg-[#071d34] flex">
      ...
      <div className="flex-1 p-4 md:p-8">
        ...
        <div className="bg-[#071d34] shadow-md rounded-lg p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-blue-500"
            >
          ...
          {qrCodeUrl && (
            <div className="text-center">
              ...
              <p className="text-xs text-slate-500 mt-2">Students can scan this QR code to mark their attendance</p>
            </div>
          )}
        </div>
...
{attendanceRecords.length === 0 ? (
  ...
  <>
    ...
    <div className="mb-6 bg-[#071d34] shadow-md rounded-lg p-4">
    ...
    <div className="space-y-4 md:hidden">
      {getFilteredRecords().length === 0 ? (
        ...
        getFilteredRecords().map((record, index) => (
          <div
            key={index}
            className="bg-[#071d34] p-4 rounded-lg shadow border"
          >
            <p className="text-sm">
    ...
    {/* Desktop View - Table */}
    <div className="hidden md:block bg-[#071d34] shadow-md rounded-lg overflow-x-auto">
