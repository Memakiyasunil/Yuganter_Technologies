    ...
    <div className="min-h-screen bg-[#071d34] flex">
      ...
      <div className="flex-1 p-4 md:p-8">
        ...
        {inquiries.length === 0 ? (
          ...
          <>
            {/* ✅ Desktop Table */}
            <div className="hidden md:block bg-[#071d34] rounded-xl shadow overflow-x-auto">
                  ...
                  {inquiries.map((inq) => (
                    <tr key={inq.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="px-3 py-1 rounded-lg text-xs bg-green-100 text-green-700">
                          {inq.course}
                        </span>
                      </td>
            ...
            <div className="md:hidden space-y-4">
              {inquiries.map((inq) => (
                <div
                  key={inq.id}
                  className="bg-[#071d34] rounded-xl shadow p-4 space-y-2"
                >
