...
>
  ...
  {/* 🔴 Notification Ping */}
  <span className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-lg animate-ping"></span>
  <span className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-lg"></span>
</button>
