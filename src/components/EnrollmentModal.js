                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full bg-gray-700 border border-gray-600 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500"
                          required
                        >
  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          {...props}
          className="w-full bg-gray-700 border border-gray-600 text-white rounded-xl px-4 py-3 pl-12 focus:outline-none focus:border-blue-500"
        />
