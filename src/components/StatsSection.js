...
export default function StatsSection() {
  ...
  return (
    <section
      ref={ref}
      className="py-20 bg-gradient-to-br from-[#071d34] via-[#0f1f2f] to-[#071d34] text-white relative overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`bg-[#071d34]/10  rounded-2xl p-6 md:p-8 border border-slate-700 hover:bg-[#071d34]/15 transition-all duration-500 hover:shadow-2xl ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
