  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative w-full max-w-2xl bg-[#071d34]/95 rounded-3xl shadow-2xl overflow-hidden"
              ...
              {showSuccess ? (
                ...
                <motion.div key="form" variants={formVariants} initial="hidden" animate="visible">
                  ...
                  <div className="bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-500 p-8 text-white relative overflow-hidden">
                    ...
                    <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-[#071d34]/10 rounded-lg blur-xl"></div>
                  </div>
