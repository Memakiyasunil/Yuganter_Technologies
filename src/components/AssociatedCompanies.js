...
const AssociatedCompanies = () => {
  ...
  return (
    <section className="relative w-full py-28 bg-gradient-to-br from-[#071d34] via-[#0f1f2f] to-[#071d34] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-slate-300 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
        ...
        >
          {companies.map((company, index) => (
            <SwiperSlide key={index}>
              <div className="group h-full flex flex-col items-center justify-center p-6 bg-[#071d34]/5  border border-slate-700 rounded-2xl transition-all duration-500 hover:border-primary-400/40 hover:bg-[#071d34]/10 hover:-translate-y-1">
                ...
                <div className="w-full h-20 flex items-center justify-center mb-4">
                  <img
                    src={company.logo}
                    alt={company.name}
                    className="max-h-16 object-contain transition duration-500 group-"
                  />
                </div>
